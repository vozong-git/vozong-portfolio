...
const SN = {
  ...
  projectCard(p) {
    const cover = p.cover_url
      ? `<img alt="${SN.escape(p.title)}" loading="lazy" decoding="async" class="w-full h-full object-cover md:group-hover:scale-105 md:transition-transform md:duration-500" src="${p.cover_url}?thumb=200"/>`
